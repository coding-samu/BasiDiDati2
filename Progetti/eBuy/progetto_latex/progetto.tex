...
\begin{enumerate}
    ...
    \item Un utente privato deve poter lasciare un feedback su un post Compralo Subito
    \item Un utente privato deve poter lasciare un feedback su un post Asta del quale risulta bidder aggiudicatario
\end{enumerate}
