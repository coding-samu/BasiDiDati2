...
\begin{enumerate}
    ...
    \item precondizioni:
    \begin{enumerate}
        \item istante\_corrente > istante\_scad(this)
        \item AND
    ...
    \item return:
    \begin{enumerate}
        \item aggiudicante = $\{$ bidder: $\forall$ b',b'',up $\exists$ bidder
        \item bid\_up$($b',up$)$ $\land$ bid\_up$($b'',bidder$)$ $\land$
        \item bid\_pa$($b',this$)$ $\land$ bid\_pa$($b'',this$)$ $\land$ bidder $\neq$ up
        \item $\rightarrow$ istante$($b''$)$ $>$ istante$($b'$)$
        \item $\}$
