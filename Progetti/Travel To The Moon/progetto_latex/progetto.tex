...
\subsection*{Classe Croc\_luna\_di\_miele}
Tabella delle specifiche degli attributi:
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        tipo & TipoCrocieraLunaDiMiele & 1 & Tipo della crociera di luna di miele \\
        \hline
    \end{tabular}
...
\subsection*{Classe\ Croc\_per\_famiglie}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome della nave \\
        grado\_di\_comfort & ValutazioneNave & 1 & Grado di comfort della nave \\
        numero\_massimo\_di\_passeggeri & InteroGZ & 1 & Numero massimo di passeggeri \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome della destinazione \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome dell'itinerario \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        ora & Ora & 1 & Ora di arrivo \\
        giorno & InteroGEZ & 1 & Giorno di arrivo \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome del posto da vedere \\
        descrizione & StringaL & 1 & Descrizione del posto da vedere \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome dell'utente \\
        cognome & StringaS & 1 & Cognome dell'utente \\
        indirizzo & StringaM & 1 & Indirizzo dell'utente \\
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        num\_posti\_prenotati & InteroGZ & 1 & Numero di posti prenotati \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome della città \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome della nazione \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome del continente \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        nome & StringaS & 1 & Nome del porto \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        giorno & Giorno & 1 & Giorno in cui è possibile visitare il posto \\
        ora\_inizio & Ora & 1 & Ora di inizio della visita \\
        ora\_fine & Ora & 1 & Ora di fine della visita \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        giorno\_arrivo & InteroGEZ & 1 & Giorno di arrivo della tappa \\
        ora\_arrivo & Ora & 1 & Ora di arrivo della tappa \\
        giorno\_partenza & InteroGEZ & 1 & Giorno di partenza della tappa \\
        ora\_partenza & Ora & 1 & Ora di partenza della tappa \\
        \hline
    \end{tabular}
