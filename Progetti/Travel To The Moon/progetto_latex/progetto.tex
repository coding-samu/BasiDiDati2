...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item ora di partenza: DeltaOra\label{sec:RequisitiItinerarioDestinazioneDiPartenzaOra}
        \end{enumerate}
        \item destinazione di arrivo (\hyperref[sec:RequisitiDestinazione]{v.req.3})\label{sec:RequisitiItinerarioDestinazioneDiArrivo}
        \begin{enumerate}
            \item ora di arrivo: DeltaOra\label{sec:RequisitiItinerarioDestinazioneDiArrivoOra}
...
Operazioni del tipo DeltaOra:

\begin{enumerate}
    \item < (d1: DeltaOra, d2: DeltaOra): booleano
    \begin{enumerate}
        \item Pre: nessuna
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        ora & \hyperref[sec:Ora]{Ora} & 1 & Ora di partenza \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        Attributo & Tipo & Cardinalità & Descrizione \\
        \hline
        ora & \hyperref[sec:Ora]{Ora} & 1 & Ora di arrivo \\
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        ora\_inizio & \hyperref[sec:Ora]{Ora} & 1 & Ora di inizio della visita \\
        ora\_fine & \hyperref[sec:Ora]{Ora} & 1 & Ora di fine della visita \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        ora\_arrivo & \hyperref[sec:Ora]{Ora} & 1 & Ora di arrivo della tappa \\
        giorno\_partenza & \hyperref[sec:InteroGEZ]{InteroGEZ} & 1 & Giorno di partenza della tappa \\
        ora\_partenza & \hyperref[sec:Ora]{Ora} & 1 & Ora di partenza della tappa \\
        \hline
    \end{tabular}
